...
let extendColorHorizontallyCheckbox = document.getElementById(
  "extendColorHorizontallyCheckbox",
);
let individualDifficultyColorCheckbox = document.getElementById(
  "individualDifficultyColorCheckbox",
);
...
function loadSettings() {
  chrome.storage.sync.get(
    ...
    function (data) {
      ...
      extendColorHorizontallyCheckbox.checked =
        data.extendColorHorizontally !== undefined
          ? data.extendColorHorizontally
          : defaults.extendColorHorizontally;
      individualDifficultyColorCheckbox.checked =
        data.individualDifficultyColor !== undefined
          ? data.individualDifficultyColor
          : defaults.individualDifficultyColor;
      includeColor2Checkbox.checked =
        data.includeColor2 !== undefined
          ? data.includeColor2
          : defaults.includeColor2;
      color1Selector.value =
        data.color1 !== undefined ? data.color1 : defaults.color1;
      color2Selector.value =
        data.color2 !== undefined ? data.color2 : defaults.color2;
      color3Selector.value =
        data.color3 !== undefined ? data.color3 : defaults.color3;
      opacitySlider.value =
        data.opacity !== undefined ? data.opacity : defaults.opacity;
      opacityValue.value =
        data.opacity !== undefined ? data.opacity : defaults.opacity;
      useEvalsCheckbox.checked =
        data.useEvals !== undefined ? data.useEvals : defaults.useEvals;
...
async function setupSettings() {
  ...
  extendColorHorizontallyCheckbox.addEventListener("change", function () {
    ...
    chrome.storage.sync.set({
      extendColorHorizontally: extendColorHorizontally,
    });
