...
authorizationButton.addEventListener('click', () => {
    chrome.runtime.sendMessage('authorize', ([authorized, failStatus]) => {
        if (authorized) {
            ...
            authorizationStatus.innerText = 'Authorized! Downloading SCU Course Evaluations...';
            chrome.runtime.sendMessage('downloadEvals', () => {
                authorizationStatus.className = 'downloaded';
                authorizationStatus.innerText = 'Downloaded SCU Course Evaluations! You can close this tab.';
