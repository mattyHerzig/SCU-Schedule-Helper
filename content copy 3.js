...
//   if (unitsColumnStyle.classList.contains("modified")) return;
//   unitsColumnStyle.classList.add("modified");
//   unitsColumnStyle.textContent = unitsColumnStyle.textContent.replace(/width:\d+PX;/, "width:100PX;");
// }
