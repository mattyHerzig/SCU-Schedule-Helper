...
export default function ProfessorRecencyIndicator({ lastTaughtQuarter, currentQuarter }) {
    const indicator = getRecencyIndicator(lastTaughtQuarter, currentQuarter);
